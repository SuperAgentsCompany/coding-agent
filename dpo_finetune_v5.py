...
def prep_dpo_data(example):
    ...
    return {
        ...
        "chosen": chosen,
        "rejected": rejected,
        # "images": [], # Try without first, unsloth might handle it
    }
...
model.save_pretrained("gemma4-coding-dpo-adapter-v5")
tokenizer.save_pretrained("gemma4-coding-dpo-adapter-v5")
print("Done!")
